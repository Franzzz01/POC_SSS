...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-white/55 backdrop-blur-md shadow-sm border-b border-surface' : 'bg-white/40'
      }`}>
